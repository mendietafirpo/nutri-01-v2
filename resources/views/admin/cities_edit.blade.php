...
@section('content')
    ...
    <div class="container max-w-2xl p-6">
        <h1 class="text-2xl font-bold mb-4">Gestión de Ciudades</h1>
        ...
        <div class="bg-gray-100 p-4 rounded mb-8">
            <h2 class="font-bold mb-2">Agregar Nueva Ciudad</h2>
            <form action="{{ route('cities.store') }}" method="POST" class="flex gap-2">
                @csrf
                <input type="text" name="city" placeholder="Nombre de la ciudad" required
        ...
        <table class="w-full bg-white shadow-md rounded">
            ...
            <tbody>
                ...
                <tr class="border-b">
                    ...
                    <td class="p-3">
                        <form action="{{ route('cities.update', $c->city) }}" method="POST" class="flex gap-2">
                            @csrf
                            @method('PUT')
